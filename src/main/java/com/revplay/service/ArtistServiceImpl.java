...
public class ArtistServiceImpl implements ArtistService {
    ...
    public ArtistProfileResponse registerArtist(ArtistRegisterRequest request) {
        ...
        // Must use the entity returned by save() — JPA assigns the DB-generated
        // id only on the returned object. Mapping from the local 'artist' variable
        // returns null for getId() since the id was never written back to it.
