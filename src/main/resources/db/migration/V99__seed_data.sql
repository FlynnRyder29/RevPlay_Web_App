...
-- │ piyush_admin         │ Password@123    │ ADMIN          │
-- │ joshua_admin         │ Password@123    │ ADMIN          │
-- │ ibrahim_admin        │ Password@123    │ ADMIN          │
-- │ sanjeev_admin        │ Password@123    │ ADMIN          │
-- │ vijay_admin          │ Password@123    │ ADMIN          │
-- │ alice_music          │ AlicePass@1     │ LISTENER       │
-- │ bob_beats            │ BobPass@123     │ LISTENER       │
-- │ (listeners 73–92)    │ Listen@123      │ LISTENER       │
...
-- │ (artists 93–103)     │ Password@123    │ ARTIST         │
-- └──────────────────────┴─────────────────┴────────────────┘
--
...
INSERT INTO users (id, email, username, password_hash, display_name, bio, role) VALUES
                                                                                    (1, 'admin@revplay.com', 'admin',        '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'RevPlay Admin', 'Platform administrator.',              'ADMIN'),
                                                                                    (2, 'alice@mail.com',    'alice_music',  '\$2a\$10\$4kRuoWAkP/uFPZwI.1bbC.nN34Xft6dOscRNYVFl2fz1Dfl.chXcy', 'Alice',         'Music lover. Playlist curator.',       'LISTENER'),
...
-- ============================================================
-- NEW ADMIN USERS (IDs 68–72)
-- ============================================================

INSERT INTO users (id, email, username, password_hash, display_name, bio, role) VALUES
                                                                                    (68, 'piyush@revplay.com',  'piyush_admin',  '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Piyush',  'Platform admin. Music is life.',       'ADMIN'),
                                                                                    (69, 'joshua@revplay.com',  'joshua_admin',  '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Joshua',  'Admin and avid playlist builder.',     'ADMIN'),
                                                                                    (70, 'ibrahim@revplay.com', 'ibrahim_admin', '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Ibrahim', 'Backend admin. Loves lo-fi beats.',    'ADMIN'),
                                                                                    (71, 'sanjeev@revplay.com', 'sanjeev_admin', '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Sanjeev', 'Admin. Bollywood and jazz fan.',       'ADMIN'),
                                                                                    (72, 'vijay@revplay.com',   'vijay_admin',   '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Vijay',   'Admin. Rock and anime OST aficionado.','ADMIN');
...
INSERT INTO users (id, email, username, password_hash, display_name, bio, role) VALUES
                                                                                    (73,  'emma@mail.com',     'emma_tunes',    '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Emma',     'Indie and folk music lover.',           'LISTENER'),
                                                                                    (74,  'liam@mail.com',     'liam_listens',  '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Liam',     'Hip-hop head. Always on the go.',       'LISTENER'),
                                                                                    (75,  'sophia@mail.com',   'sophia_beats',  '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Sophia',   'Pop and R&B is my vibe.',               'LISTENER'),
                                                                                    (76,  'noah@mail.com',     'noah_waves',    '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Noah',     'Electronic and chillwave fan.',         'LISTENER'),
                                                                                    (77,  'olivia@mail.com',   'olivia_music',  '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Olivia',   'Anime OST obsessed.',                   'LISTENER'),
                                                                                    (78,  'ethan@mail.com',    'ethan_hifi',    '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Ethan',    'Rock and alternative music only.',      'LISTENER'),
                                                                                    (79,  'ava@mail.com',      'ava_playlist',  '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Ava',      'Playlist curator extraordinaire.',      'LISTENER'),
                                                                                    (80,  'mason@mail.com',    'mason_jams',    '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Mason',    'Jazz and blues aficionado.',            'LISTENER'),
                                                                                    (81,  'isabella@mail.com', 'isabella_sings','\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Isabella', 'K-pop and J-pop fan.',                  'LISTENER'),
                                                                                    (82,  'james@mail.com',    'james_groove',  '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'James',    'Bollywood and pop mix.',                'LISTENER'),
                                                                                    (83,  'mia@mail.com',      'mia_vibes',     '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Mia',      'Chill and lofi for studying.',          'LISTENER'),
                                                                                    (84,  'lucas@mail.com',    'lucas_loud',    '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Lucas',    'Metal and prog rock fan.',              'LISTENER'),
                                                                                    (85,  'charlotte@mail.com','charlotte_pop', '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Charlotte','Pop princess. Knows every lyric.',     'LISTENER'),
                                                                                    (86,  'henry@mail.com',    'henry_hears',   '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Henry',    'Classical and modern fusion.',          'LISTENER'),
                                                                                    (87,  'amelia@mail.com',   'amelia_notes',  '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Amelia',   'Singer who loves discovering artists.', 'LISTENER'),
                                                                                    (88,  'jack@mail.com',     'jack_bass',     '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Jack',     'Bass music and EDM all day.',           'LISTENER'),
                                                                                    (89,  'lily@mail.com',     'lily_lyrics',   '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Lily',     'Knows every lyric to every song.',     'LISTENER'),
                                                                                    (90,  'ryan@mail.com',     'ryan_radio',    '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Ryan',     'Radio enthusiast gone digital.',        'LISTENER'),
                                                                                    (91,  'zoe@mail.com',      'zoe_zen',       '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Zoe',      'Meditation and ambient soundscapes.',   'LISTENER'),
                                                                                    (92,  'aiden@mail.com',    'aiden_alt',     '\$2a$10$VHT7DPPaR48IWqTDi0mgZORasdBfKHsdT1KwIu9PnOGlWAQL0ndB.', 'Aiden',    'Alt rock and post-punk.',               'LISTENER');

-- ============================================================
-- ARTIST USERS (IDs 8, 11, 12–67, 93–103)
-- ============================================================

INSERT INTO users (id, email, username, password_hash, display_name, bio, role) VALUES
                                                                                    (8,  'd4vd@mail.com',            'd4vd',              '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'D4vd',              'Indie R&B artist from Houston, TX.',                            'ARTIST'),
                                                                                    (11, 'macdemarco@mail.com',      'mac_demarco',       '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Mac DeMarco',       'Canadian indie rock and jangle pop musician.',                  'ARTIST');

INSERT INTO users (id, email, username, password_hash, display_name, bio, role) VALUES
                                                                                    (12, 'billieeilish@mail.com',    'billie_eilish',     '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Billie Eilish',     'Pop and alternative artist from Los Angeles.',                  'ARTIST'),
                                                                                    (13, 'boa@mail.com',             'boa_official',      '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Boa',               'British singer known for Duvet.',                               'ARTIST'),
                                                                                    (14, 'djo@mail.com',             'djo_music',         '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Djo',               'Indie pop artist and actor Joe Keery.',                         'ARTIST'),
                                                                                    (15, 'richymitch@mail.com',      'richy_mitch',       '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Richy Mitch & The Coal Miners','Folk and indie rock band.',                               'ARTIST'),
                                                                                    (16, 'radiohead@mail.com',       'radiohead',         '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Radiohead',         'British rock band from Abingdon.',                              'ARTIST'),
                                                                                    (17, 'surfcurse@mail.com',       'surf_curse',        '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Surf Curse',        'Indie rock duo from Reno, Nevada.',                             'ARTIST'),
                                                                                    (18, 'laufey@mail.com',          'laufey',            '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Laufey',            'Icelandic jazz-pop singer-songwriter.',                          'ARTIST'),
                                                                                    (19, 'sukiwaterhouse@mail.com',  'suki_waterhouse',   '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Suki Waterhouse',   'British singer-songwriter and actress.',                        'ARTIST'),
                                                                                    (20, 'imogenheap@mail.com',      'imogen_heap',       '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Imogen Heap',       'British singer, songwriter and record producer.',               'ARTIST'),
                                                                                    (21, 'thesmiths@mail.com',       'the_smiths',        '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'The Smiths',        'British rock band from Manchester.',                            'ARTIST'),
                                                                                    (22, 'walters@mail.com',         'walters_music',     '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Walters',           'Indie pop artist.',                                             'ARTIST'),
                                                                                    (23, 'tameimpala@mail.com',      'tame_impala',       '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Tame Impala',       'Psychedelic rock project by Kevin Parker.',                     'ARTIST'),
                                                                                    (24, 'tylerthecreator@mail.com', 'tyler_the_creator', '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Tyler the Creator', 'Rapper and producer from Los Angeles.',                         'ARTIST'),
                                                                                    (25, 'mgmt@mail.com',            'mgmt_official',     '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'MGMT',              'Indie pop and psychedelic rock duo.',                           'ARTIST'),
                                                                                    (26, 'tvgirl@mail.com',          'tv_girl',           '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'TV Girl',           'Indie pop band from San Diego.',                                'ARTIST'),
                                                                                    (27, 'ankittiwari@mail.com',     'ankit_tiwari',      '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Ankit Tiwari',      'Indian playback singer and composer.',                          'ARTIST'),
                                                                                    (28, 'faeemashraf@mail.com',     'faheem_ashraf',     '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Faheem Ashraf',     'Pakistani singer-songwriter.',                                  'ARTIST'),
                                                                                    (29, 'mananbhardwaj@mail.com',   'manan_bhardwaj',    '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Manan Bhardwaj',    'Indian playback singer.',                                       'ARTIST'),
                                                                                    (30, 'sukhwindersingh@mail.com', 'sukhwinder_singh',  '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Sukhwinder Singh',  'Indian playback singer known for Jai Ho.',                      'ARTIST'),
                                                                                    (31, 'arijitsingh@mail.com',     'arijit_singh',      '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Arijit Singh',      'Indian playback singer and music composer.',                    'ARTIST'),
                                                                                    (32, 'bpraak@mail.com',          'b_praak',           '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'B Praak',           'Indian singer and music producer.',                             'ARTIST'),
                                                                                    (33, 'roopkumar@mail.com',       'roop_kumar',        '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Roop Kumar',        'Indian playback singer.',                                       'ARTIST'),
                                                                                    (34, 'sonunigam@mail.com',       'sonu_nigam',        '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Sonu Nigam',        'Indian playback singer and composer.',                          'ARTIST'),
                                                                                    (35, 'palakmucchal@mail.com',    'palak_mucchal',     '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Palak Mucchal',     'Indian playback singer.',                                       'ARTIST'),
                                                                                    (36, 'edsheeran@mail.com',       'ed_sheeran',        '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Ed Sheeran',        'British singer-songwriter.',                                    'ARTIST'),
                                                                                    (37, 'justinbieber@mail.com',    'justin_bieber',     '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Justin Bieber',     'Canadian pop singer.',                                          'ARTIST'),
                                                                                    (38, 'akon@mail.com',            'akon_official',     '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Akon',              'Senegalese-American R&B and pop singer.',                       'ARTIST'),
                                                                                    (39, 'dollyparton@mail.com',     'dolly_parton',      '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Dolly Parton',      'American country music singer-songwriter.',                     'ARTIST'),
                                                                                    (40, 'enriqueiglesias@mail.com', 'enrique_iglesias',  '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Enrique Iglesias',  'Spanish singer known as the King of Latin Pop.',                'ARTIST'),
                                                                                    (41, 'selenagomez@mail.com',     'selena_gomez',      '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Selena Gomez',      'American singer, actress and producer.',                        'ARTIST'),
                                                                                    (42, 'linkinpark@mail.com',      'linkin_park',       '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Linkin Park',       'American rock band from Agoura Hills, California.',             'ARTIST'),
                                                                                    (43, 'fictionjunction@mail.com', 'fiction_junction',  '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Fiction Junction',  'Japanese music unit by Yuki Kajiura.',                          'ARTIST'),
                                                                                    (44, 'lisa@mail.com',            'lisa_official',     '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'LiSA',              'Japanese rock singer known for Demon Slayer themes.',           'ARTIST'),
                                                                                    (45, 'arkpetrol@mail.com',       'ark_petrol',        '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Ark Petrol',        'Indie artist.',                                                 'ARTIST'),
                                                                                    (46, 'bonesuk@mail.com',         'bones_uk',          '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Bones UK',          'British rock band.',                                            'ARTIST'),
                                                                                    (47, 'manwithamission@mail.com', 'man_with_a_mission','\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Man With a Mission and Milet','Japanese rock band collaboration with singer Milet.',     'ARTIST'),
                                                                                    (48, 'poormanspois@mail.com',    'poor_mans_poison',  '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Poor Mans Poison',  'Dark folk and fantasy music artist.',                           'ARTIST'),
                                                                                    (49, 'sergenova@mail.com',       'serge_nova',        '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Serge Nova',        'Indie pop artist.',                                             'ARTIST'),
                                                                                    (50, 'againstthecurrent@mail.com','against_the_current','\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy','Against the Current','American pop rock band.',                                    'ARTIST'),
                                                                                    (51, 'thefatrat@mail.com',       'thefatrat_maisykay','\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'TheFatRat and Maisy Kay','Electronic music producer TheFatRat ft. vocalist Maisy Kay.','ARTIST'),
                                                                                    (52, 'yuikooohara@mail.com',     'yuiko_ohara',       '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Yuiko Ohara',       'Japanese singer known for Mushoku Tensei themes.',              'ARTIST'),
                                                                                    (53, 'konomisuzuki@mail.com',    'konomi_suzuki',     '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Konomi Suzuki',     'Japanese singer known for No Game No Life OP.',                 'ARTIST'),
                                                                                    (54, 'yoasobi@mail.com',         'yoasobi',           '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'YOASOBI',           'Japanese music duo known for Racing into the Night.',           'ARTIST'),
                                                                                    (55, 'gawrgura@mail.com',        'gawr_gura',         '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Gawr Gura',         'VTuber and singer from Hololive.',                              'ARTIST'),
                                                                                    (56, 'kinggnu@mail.com',         'king_gnu',          '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'King Gnu',          'Japanese art rock band known for Specialz.',                    'ARTIST'),
                                                                                    (57, 'goosehouse@mail.com',      'goose_house',       '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Goose House',       'Japanese music group known for Hikaru Nara.',                   'ARTIST'),
                                                                                    (58, 'gloriagaynor@mail.com',    'gloria_gaynor',     '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Gloria Gaynor',     'American disco and R&B singer.',                                'ARTIST'),
                                                                                    (59, 'fieldofview@mail.com',     'field_of_view',     '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Field of View',     'Japanese band known for Dragon Ball GT OP.',                    'ARTIST'),
                                                                                    (60, 'fictionjunction2@mail.com','fictionjunction',   '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'FictionJunction',   'Japanese music project by Yuki Kajiura for anime themes.',      'ARTIST'),
                                                                                    (61, 'lennycodefiction@mail.com','lenny_code_fiction','\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Lenny Code Fiction','Japanese band known for My Hero Academia OP.',                  'ARTIST'),
                                                                                    (62, 'fujiikaze@mail.com',       'fujii_kaze',        '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Fujii Kaze',        'Japanese singer-songwriter and pianist.',                       'ARTIST'),
                                                                                    (63, 'hiroyukisawano@mail.com',  'hiroyuki_sawano',   '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Hiroyuki Sawano',   'Japanese composer known for Attack on Titan OST.',              'ARTIST'),
                                                                                    (64, 'lisafelixstraykids@mail.com','lisa_felix_straykids','\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy','Lisa feat. Felix of Stray Kids','Collaboration between LiSA and Felix from Stray Kids.','ARTIST'),
                                                                                    (65, 'ikimonogakari@mail.com',   'ikimonogakari',     '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Ikimonogakari',     'Japanese pop band known for Blue Bird (Naruto OP).',            'ARTIST'),
                                                                                    (66, 'sim@mail.com',             'sim_official',      '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'SiM',               'Japanese punk reggae band known for The Rumbling.',             'ARTIST'),
                                                                                    (67, 'tk@mail.com',              'tk_official',       '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'TK',                'Japanese musician known for Unravel (Tokyo Ghoul OP).',         'ARTIST');

-- New artist users (IDs 93–103) — formerly 68–78
INSERT INTO users (id, email, username, password_hash, display_name, bio, role) VALUES
                                                                                    (93,  'alanwalker@mail.com',      'alan_walker',       '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Alan Walker',       'Norwegian DJ and music producer known for Alone and Faded.',   'ARTIST'),
                                                                                    (94,  'imaginedragons@mail.com',  'imagine_dragons',   '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Imagine Dragons',   'American pop rock band from Las Vegas.',                        'ARTIST'),
                                                                                    (95,  'leagueoflegends@mail.com', 'league_of_legends', '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'League of Legends', 'Official music channel for League of Legends esports themes.',  'ARTIST'),
                                                                                    (96,  'keane@mail.com',           'keane_official',    '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Keane',             'British rock band known for Somewhere Only We Know.',          'ARTIST'),
                                                                                    (97,  'hyde@mail.com',            'hyde_official',     '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Hyde',              'Japanese rock vocalist known for Demon Slayer insert songs.',  'ARTIST'),
                                                                                    (98,  'finalfantasyix@mail.com',  'final_fantasy_ix',  '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Final Fantasy IX',  'Official music from the Final Fantasy IX game soundtrack.',     'ARTIST'),
                                                                                    (99,  'mikimatsubara@mail.com',   'miki_matsubara',    '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Miki Matsubara',    'Japanese city pop singer known for Stay With Me.',              'ARTIST'),
                                                                                    (100, 'melaniemartinez@mail.com', 'melanie_martinez',  '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Melanie Martinez',  'American singer-songwriter known for her dark pop aesthetic.',  'ARTIST'),
                                                                                    (101, 'akarikito@mail.com',       'akari_kito',        '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Akari Kito',        'Japanese voice actress and singer known for Hanako-kun themes.','ARTIST'),
                                                                                    (102, 'akeboshi@mail.com',        'akeboshi_music',    '\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy', 'Akeboshi',          'Japanese singer-songwriter known for Wind from Naruto.',        'ARTIST'),
                                                                                    (103, 'thousandfootkrutch@mail.com','thousand_foot_krutch','\$2a$10$fTeCnQhtcsF41WuYA7mkSOHSgxP1FWJ8yaSwXXHGUGo/Krr6Au.Hy','Thousand Foot Krutch','Canadian Christian rock band known for Courtesy Call.',     'ARTIST');
...
-- ============================================================
-- ARTISTS (IDs 62–72) — remapped user_ids to 93–103
-- ============================================================

INSERT INTO artists (id, user_id, artist_name, bio, genre, profile_picture_url, banner_image_url, instagram, twitter, youtube, spotify, website) VALUES
                                                                                                                                                     (62, 93, 'Alan Walker',              'Norwegian DJ and record producer known for Alone, Faded, and On My Way.',                'Electronic', 'https://picsum.photos/seed/alanwalker-pfp/300/300',    'https://picsum.photos/seed/alanwalker-banner/1200/400',    'https://instagram.com/alanwalkermusic', 'https://twitter.com/alanwalker97', 'https://youtube.com/@alanwalker97', NULL, NULL),
                                                                                                                                                     (63, 94, 'Imagine Dragons',          'American pop rock band from Las Vegas known for Warriors and Demons.',                   'Rock',       'https://picsum.photos/seed/imaginedragons-pfp/300/300', 'https://picsum.photos/seed/imaginedragons-banner/1200/400', 'https://instagram.com/imaginedragons', 'https://twitter.com/imaginedragons', 'https://youtube.com/@imaginedragons', NULL, NULL),
                                                                                                                                                     (64, 95, 'League of Legends',        'Official artist channel for League of Legends esports and game music.',                 'Electronic', 'https://i.scdn.co/image/ab67616d0000b273304ae5169ad8e53e261b93f2', 'https://picsum.photos/seed/lol-banner/1200/400', NULL, NULL, 'https://youtube.com/@leagueoflegends', NULL, NULL),
                                                                                                                                                     (65, 96, 'Keane',                    'British rock band from Battle, East Sussex, known for Somewhere Only We Know.',         'Rock',       'https://picsum.photos/seed/keane-pfp/300/300',         'https://picsum.photos/seed/keane-banner/1200/400',         NULL, 'https://twitter.com/keaneofficial', NULL, NULL, NULL),
                                                                                                                                                     (66, 97, 'Hyde',                     'Japanese rock vocalist, member of L''Arc-en-Ciel, known for Demon Slayer insert songs.','Rock',       'https://picsum.photos/seed/hyde-pfp/300/300',          'https://picsum.photos/seed/hyde-banner/1200/400',          'https://instagram.com/hydeofficial', NULL, NULL, NULL, NULL),
                                                                                                                                                     (67, 98, 'Final Fantasy IX',         'Official music from the Final Fantasy IX game, composed by Nobuo Uematsu.',             'Electronic', 'https://i.scdn.co/image/ab67616d0000b27397bc434b73f6344af6a0d07b', 'https://picsum.photos/seed/ffix-banner/1200/400', NULL, NULL, NULL, NULL, NULL),
                                                                                                                                                     (68, 99, 'Miki Matsubara',           'Japanese city pop singer known for the timeless Stay With Me.',                         'Pop',        'https://cdn-images.dzcdn.net/images/cover/9167ba9c16a4e5f2c39691ee27a30029/0x1900-000000-80-0-0.jpg', 'https://picsum.photos/seed/mikimatsubara-banner/1200/400', NULL, NULL, NULL, NULL, NULL),
                                                                                                                                                     (69, 100, 'Melanie Martinez',         'American singer-songwriter known for her whimsical dark pop style.',                    'Pop',        'https://i1.sndcdn.com/artworks-O1lwpozUA9GDtxPs-kUyaQQ-t500x500.jpg', 'https://picsum.photos/seed/melaniemartinez-banner/1200/400', 'https://instagram.com/melaniemartinez', 'https://twitter.com/melaniemusic', NULL, NULL, NULL),
                                                                                                                                                     (70, 101, 'Akari Kito',               'Japanese voice actress and singer known for Hanako-kun and Kimetsu no Yaiba themes.',   'Anime',      'https://i1.sndcdn.com/artworks-zBYj2TbkUw8QVITt-6xl9jQ-t500x500.jpg', 'https://picsum.photos/seed/akarikito-banner/1200/400', 'https://instagram.com/akarikito_official', NULL, NULL, NULL, NULL),
                                                                                                                                                     (71, 102, 'Akeboshi',                 'Japanese singer-songwriter known for Wind, the second Naruto ending theme.',            'Anime',      'https://i.scdn.co/image/ab67616d0000b27319ccf9d983d109bbb710e3b8', 'https://picsum.photos/seed/akeboshi-banner/1200/400', NULL, NULL, NULL, NULL, NULL),
                                                                                                                                                     (72, 103, 'Thousand Foot Krutch',     'Canadian Christian rock band known for Courtesy Call used in Sword Art Online AMVs.',   'Rock',       'https://c.saavncdn.com/161/End-Is-Where-We-Begin-English-2019-20210112055134-500x500.jpg', 'https://picsum.photos/seed/thousandfootkrutch-banner/1200/400', 'https://instagram.com/thousandfootkrutch', NULL, NULL, NULL, NULL);
...
-- ============================================================
-- SONGS (IDs 16–104) — all in one continuous INSERT
-- ============================================================
...
-- ── FIXED: audio_url and cover_image_url were swapped ────────
(58, 'Rhythm Divine',
 'Pop', 248,
...
-- ============================================================
-- PLAYLIST SONGS — original songs 16–89
-- ============================================================
...
-- ============================================================
-- ADD NEW SONGS (90–104) TO EXISTING PLAYLISTS
-- ============================================================

INSERT INTO playlist_songs (playlist_id, song_id, position) VALUES
-- Electronic Overload (playlist 10)
(10, 90, 5), (10, 91, 6), (10, 92, 7), (10, 95, 8),
-- Rock & Alternative (playlist 6)
(6, 93, 7), (6, 94, 8), (6, 96, 9), (6, 104, 10),
-- Anime Anthems (playlist 5)
(5, 97, 8), (5, 101, 9), (5, 102, 10), (5, 103, 11),
-- Pop World (playlist 7)
(7, 99, 7), (7, 100, 8), (7, 84, 9),
-- Top Charts (playlist 12)
(12, 93, 8), (12, 90, 9), (12, 91, 10),
-- Workout Beast Mode (playlist 14)
(14, 93, 7), (14, 104, 8), (14, 95, 9),
-- Weekend Vibes (playlist 15)
(15, 90, 8), (15, 94, 9), (15, 100, 10);

-- ============================================================
-- FAVORITES — original listeners
-- ============================================================
...
-- ============================================================
-- ADDITIONAL FAVORITES — new songs + more listener activity
-- ============================================================
...
-- ============================================================
-- ADDITIONAL LISTENING HISTORY — more users, newer songs
-- ============================================================

INSERT INTO listening_history (user_id, song_id, played_at) VALUES
-- Mason
(80, 96, NOW() - INTERVAL 20 MINUTE),
(80, 98, NOW() - INTERVAL 1 HOUR),
-- Isabella
(81, 86, NOW() - INTERVAL 10 MINUTE),
(81, 87, NOW() - INTERVAL 45 MINUTE),
(81, 78, NOW() - INTERVAL 2 HOUR),
-- James
(82, 93, NOW() - INTERVAL 5 MINUTE),
(82, 42, NOW() - INTERVAL 30 MINUTE),
(82, 45, NOW() - INTERVAL 1 HOUR),
-- Mia
(83, 90, NOW() - INTERVAL 15 MINUTE),
(83, 25, NOW() - INTERVAL 50 MINUTE),
-- Lucas
(84, 104, NOW() - INTERVAL 8 MINUTE),
(84, 88, NOW() - INTERVAL 40 MINUTE),
-- Charlotte
(85, 100, NOW() - INTERVAL 12 MINUTE),
(85, 49, NOW() - INTERVAL 1 HOUR),
-- Henry
(86, 98, NOW() - INTERVAL 25 MINUTE),
-- Amelia
(87, 76, NOW() - INTERVAL 18 MINUTE),
(87, 89, NOW() - INTERVAL 1 HOUR),
-- Jack
(88, 90, NOW() - INTERVAL 7 MINUTE),
(88, 92, NOW() - INTERVAL 35 MINUTE),
-- Lily
(89, 99, NOW() - INTERVAL 22 MINUTE),
-- Ryan
(90, 93, NOW() - INTERVAL 3 MINUTE),
(90, 78, NOW() - INTERVAL 30 MINUTE),
-- Zoe
(91, 25, NOW() - INTERVAL 14 MINUTE),
-- Aiden
(92, 22, NOW() - INTERVAL 9 MINUTE),
(92, 68, NOW() - INTERVAL 45 MINUTE);

-- ============================================================
-- PLAY EVENTS (analytics) — original
-- ============================================================

INSERT INTO play_events (song_id, user_id, played_at) VALUES
-- Saiyyara (36) — highest play_count
...
-- ============================================================
-- EXPANDED PLAY EVENTS — cover songs 90–104 + wider time spread
-- ============================================================

INSERT INTO play_events (song_id, user_id, played_at) VALUES
-- Warriors (93) — Imagine Dragons
(93, 82, NOW() - INTERVAL 3 MINUTE),
(93, 74, NOW() - INTERVAL 20 MINUTE),
(93, 90, NOW() - INTERVAL 1 HOUR),
(93, NULL, NOW() - INTERVAL 3 HOUR),
(93, 78, NOW() - INTERVAL 1 DAY),
(93, 3, NOW() - INTERVAL 2 DAY),
(93, NULL, NOW() - INTERVAL 5 DAY),
(93, 84, NOW() - INTERVAL 7 DAY),
(93, 2, NOW() - INTERVAL 10 DAY),

-- Alone (90) — Alan Walker
(90, 83, NOW() - INTERVAL 5 MINUTE),
(90, 88, NOW() - INTERVAL 30 MINUTE),
(90, 76, NOW() - INTERVAL 2 HOUR),
(90, NULL, NOW() - INTERVAL 5 HOUR),
(90, 73, NOW() - INTERVAL 1 DAY),
(90, NULL, NOW() - INTERVAL 3 DAY),
(90, 2, NOW() - INTERVAL 6 DAY),

-- On My Way (91) — Alan Walker
(91, 73, NOW() - INTERVAL 15 MINUTE),
(91, NULL, NOW() - INTERVAL 2 HOUR),
(91, 76, NOW() - INTERVAL 1 DAY),
(91, 88, NOW() - INTERVAL 4 DAY),

-- Darkside (92) — Alan Walker
(92, 88, NOW() - INTERVAL 10 MINUTE),
(92, NULL, NOW() - INTERVAL 1 HOUR),
(92, 76, NOW() - INTERVAL 2 DAY),

-- Demons (94) — Imagine Dragons
(94, 78, NOW() - INTERVAL 8 MINUTE),
(94, 90, NOW() - INTERVAL 45 MINUTE),
(94, NULL, NOW() - INTERVAL 3 HOUR),
(94, 74, NOW() - INTERVAL 1 DAY),
(94, 2, NOW() - INTERVAL 5 DAY),

-- Rise (95) — League of Legends
(95, 76, NOW() - INTERVAL 12 MINUTE),
(95, 88, NOW() - INTERVAL 1 HOUR),
(95, NULL, NOW() - INTERVAL 4 HOUR),
(95, 77, NOW() - INTERVAL 1 DAY),

-- Somewhere Only We Know (96) — Keane
(96, 80, NOW() - INTERVAL 20 MINUTE),
(96, 73, NOW() - INTERVAL 2 HOUR),
(96, NULL, NOW() - INTERVAL 1 DAY),

-- Tokoshie (97) — Hyde
(97, 77, NOW() - INTERVAL 15 MINUTE),
(97, NULL, NOW() - INTERVAL 1 HOUR),
(97, 81, NOW() - INTERVAL 1 DAY),

-- Melodies of Life (98) — Final Fantasy IX
(98, 86, NOW() - INTERVAL 25 MINUTE),
(98, 80, NOW() - INTERVAL 2 HOUR),

-- Stay With Me (99) — Miki Matsubara
(99, 89, NOW() - INTERVAL 10 MINUTE),
(99, 79, NOW() - INTERVAL 1 HOUR),
(99, NULL, NOW() - INTERVAL 3 HOUR),
(99, 75, NOW() - INTERVAL 1 DAY),

-- Play Date (100) — Melanie Martinez
(100, 85, NOW() - INTERVAL 12 MINUTE),
(100, 75, NOW() - INTERVAL 50 MINUTE),
(100, NULL, NOW() - INTERVAL 2 HOUR),
(100, 79, NOW() - INTERVAL 1 DAY),

-- Tiny Light (101) — Akari Kito
(101, 77, NOW() - INTERVAL 18 MINUTE),
(101, 81, NOW() - INTERVAL 1 HOUR),

-- Merry Go Round (102) — Man With a Mission
(102, 77, NOW() - INTERVAL 8 MINUTE),
(102, 81, NOW() - INTERVAL 40 MINUTE),
(102, NULL, NOW() - INTERVAL 2 HOUR),

-- Wind (103) — Akeboshi
(103, 77, NOW() - INTERVAL 22 MINUTE),
(103, 87, NOW() - INTERVAL 1 HOUR),
(103, NULL, NOW() - INTERVAL 3 HOUR),
(103, 74, NOW() - INTERVAL 1 DAY),

-- Courtesy Call (104) — Thousand Foot Krutch
(104, 84, NOW() - INTERVAL 8 MINUTE),
(104, 78, NOW() - INTERVAL 35 MINUTE),
(104, NULL, NOW() - INTERVAL 2 HOUR),
(104, 74, NOW() - INTERVAL 1 DAY),

-- Backfill older songs with wider time spread for trends
-- Unravel (89)
(89, 77, NOW() - INTERVAL 6 DAY),
(89, 87, NOW() - INTERVAL 10 DAY),
(89, NULL, NOW() - INTERVAL 14 DAY),
-- Blue Bird (87)
(87, 77, NOW() - INTERVAL 4 DAY),
(87, 74, NOW() - INTERVAL 8 DAY),
(87, NULL, NOW() - INTERVAL 12 DAY),
-- Hikaru Nara (79)
(79, 77, NOW() - INTERVAL 3 DAY),
(79, 87, NOW() - INTERVAL 7 DAY),
-- From The Start (25)
(25, 2, NOW() - INTERVAL 2 DAY),
(25, 83, NOW() - INTERVAL 5 DAY),
(25, 91, NOW() - INTERVAL 9 DAY),
-- Kesariya (40)
(40, 3, NOW() - INTERVAL 1 DAY),
(40, 82, NOW() - INTERVAL 4 DAY),
(40, NULL, NOW() - INTERVAL 8 DAY),
-- CHIHIRO (18)
(18, 75, NOW() - INTERVAL 2 DAY),
(18, 2, NOW() - INTERVAL 6 DAY),
(18, NULL, NOW() - INTERVAL 11 DAY),
-- Let It Happen (31)
(31, 76, NOW() - INTERVAL 3 DAY),
(31, NULL, NOW() - INTERVAL 7 DAY),
-- I Love You So (30)
(30, 79, NOW() - INTERVAL 2 DAY),
(30, 2, NOW() - INTERVAL 6 DAY),
-- Freaks (24)
(24, 73, NOW() - INTERVAL 4 DAY),
(24, 92, NOW() - INTERVAL 9 DAY),
-- Sorry (50)
(50, 75, NOW() - INTERVAL 3 DAY),
(50, NULL, NOW() - INTERVAL 8 DAY),
-- Ranjha (45)
(45, 82, NOW() - INTERVAL 2 DAY),
(45, 3, NOW() - INTERVAL 5 DAY),
-- Racing into the Night (76)
(76, 87, NOW() - INTERVAL 1 DAY),
(76, 77, NOW() - INTERVAL 4 DAY),
(76, NULL, NOW() - INTERVAL 9 DAY),
-- Legends Never Die (72)
(72, 78, NOW() - INTERVAL 3 DAY),
(72, 84, NOW() - INTERVAL 7 DAY),
-- Beautiful is Boring (68)
(68, 78, NOW() - INTERVAL 5 DAY),
(68, 92, NOW() - INTERVAL 10 DAY),
-- Bailando (56)
(56, 75, NOW() - INTERVAL 2 DAY),
(56, NULL, NOW() - INTERVAL 6 DAY),
-- Good For You (60)
(60, 75, NOW() - INTERVAL 4 DAY),
(60, 85, NOW() - INTERVAL 8 DAY),
-- What I've Done (64)
(64, 78, NOW() - INTERVAL 1 DAY),
(64, 84, NOW() - INTERVAL 5 DAY),
(64, 74, NOW() - INTERVAL 9 DAY);

-- ============================================================
-- STAGGER created_at FOR ADMIN GROWTH CHART
-- ============================================================

-- Admins — created 25-30 days ago
UPDATE users SET created_at = NOW() - INTERVAL 30 DAY WHERE id = 1;
UPDATE users SET created_at = NOW() - INTERVAL 28 DAY WHERE id = 68;
UPDATE users SET created_at = NOW() - INTERVAL 27 DAY WHERE id = 69;
UPDATE users SET created_at = NOW() - INTERVAL 26 DAY WHERE id = 70;
UPDATE users SET created_at = NOW() - INTERVAL 25 DAY WHERE id = 71;
UPDATE users SET created_at = NOW() - INTERVAL 24 DAY WHERE id = 72;

-- Original artists — 20-22 days ago
UPDATE users SET created_at = NOW() - INTERVAL 22 DAY WHERE id = 4;
UPDATE users SET created_at = NOW() - INTERVAL 21 DAY WHERE id = 5;
UPDATE users SET created_at = NOW() - INTERVAL 20 DAY WHERE id = 6;

-- Original listeners — 18-19 days ago
UPDATE users SET created_at = NOW() - INTERVAL 19 DAY WHERE id = 2;
UPDATE users SET created_at = NOW() - INTERVAL 18 DAY WHERE id = 3;

-- Batch artists (IDs 8, 11–67) — spread across 5-17 days ago
UPDATE users SET created_at = NOW() - INTERVAL 17 DAY WHERE id = 8;
UPDATE users SET created_at = NOW() - INTERVAL 17 DAY WHERE id = 11;
UPDATE users SET created_at = NOW() - INTERVAL 16 DAY WHERE id = 12;
UPDATE users SET created_at = NOW() - INTERVAL 16 DAY WHERE id = 13;
UPDATE users SET created_at = NOW() - INTERVAL 15 DAY WHERE id = 14;
UPDATE users SET created_at = NOW() - INTERVAL 15 DAY WHERE id = 15;
UPDATE users SET created_at = NOW() - INTERVAL 14 DAY WHERE id = 16;
UPDATE users SET created_at = NOW() - INTERVAL 14 DAY WHERE id = 17;
UPDATE users SET created_at = NOW() - INTERVAL 13 DAY WHERE id = 18;
UPDATE users SET created_at = NOW() - INTERVAL 13 DAY WHERE id = 19;
UPDATE users SET created_at = NOW() - INTERVAL 12 DAY WHERE id = 20;
UPDATE users SET created_at = NOW() - INTERVAL 12 DAY WHERE id = 21;
UPDATE users SET created_at = NOW() - INTERVAL 11 DAY WHERE id = 22;
UPDATE users SET created_at = NOW() - INTERVAL 11 DAY WHERE id = 23;
UPDATE users SET created_at = NOW() - INTERVAL 10 DAY WHERE id = 24;
UPDATE users SET created_at = NOW() - INTERVAL 10 DAY WHERE id = 25;
UPDATE users SET created_at = NOW() - INTERVAL 9 DAY  WHERE id = 26;
UPDATE users SET created_at = NOW() - INTERVAL 9 DAY  WHERE id = 27;
UPDATE users SET created_at = NOW() - INTERVAL 8 DAY  WHERE id = 28;
UPDATE users SET created_at = NOW() - INTERVAL 8 DAY  WHERE id = 29;
UPDATE users SET created_at = NOW() - INTERVAL 7 DAY  WHERE id = 30;
UPDATE users SET created_at = NOW() - INTERVAL 7 DAY  WHERE id = 31;
UPDATE users SET created_at = NOW() - INTERVAL 7 DAY  WHERE id = 32;
UPDATE users SET created_at = NOW() - INTERVAL 6 DAY  WHERE id = 33;
UPDATE users SET created_at = NOW() - INTERVAL 6 DAY  WHERE id = 34;
UPDATE users SET created_at = NOW() - INTERVAL 6 DAY  WHERE id = 35;
UPDATE users SET created_at = NOW() - INTERVAL 5 DAY  WHERE id IN (36,37,38,39,40);
UPDATE users SET created_at = NOW() - INTERVAL 5 DAY  WHERE id IN (41,42,43,44,45);
UPDATE users SET created_at = NOW() - INTERVAL 4 DAY  WHERE id IN (46,47,48,49,50);
UPDATE users SET created_at = NOW() - INTERVAL 4 DAY  WHERE id IN (51,52,53,54,55);
UPDATE users SET created_at = NOW() - INTERVAL 3 DAY  WHERE id IN (56,57,58,59,60);
UPDATE users SET created_at = NOW() - INTERVAL 3 DAY  WHERE id IN (61,62,63,64,65);
UPDATE users SET created_at = NOW() - INTERVAL 2 DAY  WHERE id IN (66,67);

-- New artist users (93–103) — 1-3 days ago
UPDATE users SET created_at = NOW() - INTERVAL 3 DAY  WHERE id IN (93,94,95);
UPDATE users SET created_at = NOW() - INTERVAL 2 DAY  WHERE id IN (96,97,98,99);
UPDATE users SET created_at = NOW() - INTERVAL 1 DAY  WHERE id IN (100,101,102,103);

-- Listeners (73–92) — spread across 1-10 days ago
UPDATE users SET created_at = NOW() - INTERVAL 10 DAY WHERE id IN (73,74);
UPDATE users SET created_at = NOW() - INTERVAL 9 DAY  WHERE id IN (75,76);
UPDATE users SET created_at = NOW() - INTERVAL 8 DAY  WHERE id IN (77,78);
UPDATE users SET created_at = NOW() - INTERVAL 7 DAY  WHERE id IN (79,80);
UPDATE users SET created_at = NOW() - INTERVAL 5 DAY  WHERE id IN (81,82);
UPDATE users SET created_at = NOW() - INTERVAL 3 DAY  WHERE id IN (83,84);
UPDATE users SET created_at = NOW() - INTERVAL 2 DAY  WHERE id IN (85,86);
UPDATE users SET created_at = NOW() - INTERVAL 1 DAY  WHERE id IN (87,88,89,90,91,92);
