...
--   d4vd@mail.com      → (same shared hash)
--   macdemarco@mail.com→ (same shared hash)
--   (IDs 12–67)        → (same shared hash)
--
-- Audio  : SoundHelix (royalty-free, stable hosted URLs)
--          JukeHost (user-uploaded, stable hosted URLs)
...
-- ============================================================
-- ADDITIONAL USERS & ARTISTS
-- ============================================================

-- D4vd (user_id=8, artist_id=4)
INSERT INTO users (id, email, username, password_hash, display_name, bio, role) VALUES
