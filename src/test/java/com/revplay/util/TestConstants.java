...
public final class TestConstants {
    ...
    public static final String TEST_USER_ROLE_LISTENER = "LISTENER";
    ...
    public static final int    TEST_SONG_DURATION      = 210;   // seconds
    ...
    public static final long   MAX_AUDIO_SIZE_BYTES = 50L * 1024 * 1024;  // 50 MB
